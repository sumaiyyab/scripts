...
# This script updates the main branch in all git repositories under .
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  -p, --path PATH    Path to search for git repositories (default: .)"
            echo "  -d, --dry-run      Show what would be done without making changes"
            echo "  -v, --verbose      Show detailed output for each repository"
            echo "  -h, --help         Show this help message"
            echo ""
            echo "Examples:"
            echo "  $0                           # Update all repos in ."
